      ...
      <main className="flex-1">
        <section className="border-b border-border bg-muted/50">
          <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <h1 className="mb-3 text-3xl font-bold text-foreground">Về Nhà Sách Cộng Đồng</h1>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Nhà Sách Cộng Đồng ra đời với mong muốn giúp việc khám phá và mua sách trở nên dễ dàng, thú vị hơn. Chúng tôi
            ...
            <div className="rounded-lg border border-border bg-card p-8 shadow-sm">
              <h3 className="text-lg font-semibold text-foreground">Vì sao chọn Nhà Sách Cộng Đồng?</h3>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="rounded-lg border border-border bg-card p-8 shadow-sm">
              ...
              <p className="mt-3 text-muted-foreground">
                Bắt đầu từ một nhóm những người yêu sách, Nhà Sách Cộng Đồng đã phát triển thành một nền tảng trực tuyến toàn
            ...
            <div className="rounded-lg border border-border bg-card p-8 shadow-sm">
              ...
              <p className="mt-3 text-muted-foreground">
                ...
                cho chúng tôi biết những tính năng bạn cần. Nhà Sách Cộng Đồng phát triển mạnh mẽ nhờ cộng đồng độc giả tận tâm
                như bạn.
              </p>
            </div>
          </div>
