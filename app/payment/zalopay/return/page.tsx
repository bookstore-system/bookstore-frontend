	...
	return (
		<div className="relative min-h-[70vh] overflow-hidden bg-gradient-to-b from-background via-muted/20 to-background px-4 py-10 sm:px-6 lg:px-8">
			<div className="pointer-events-none absolute inset-0">
				<div className="absolute left-1/2 top-0 h-72 w-72 -translate-x-1/2 rounded-full bg-[#0068ff]/10 blur-3xl" />
				<div className="absolute right-0 top-24 h-64 w-64 rounded-full bg-[#00b2ff]/10 blur-3xl" />
				<div className="absolute bottom-0 left-0 h-64 w-64 rounded-full bg-[#1cc8ff]/10 blur-3xl" />
			</div>
